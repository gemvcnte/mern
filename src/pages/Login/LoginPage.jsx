    ...
    <>
      ...
      <div className='w-1/3 flex justify-center items-center flex-col gap-7'>
        ...
        <div>
          ...
          <div class="relative h-11 w-full min-w-[200px] mb-10">
          ...
          <div>
          <Button type='button' onClick={handleLogin} class="relative px-8 py-2 rounded-md bg-transparent isolation-auto z-10 border-2 border-gray-500 min-w-[300px]
